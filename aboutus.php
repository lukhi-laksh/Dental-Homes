      ...
      <section class="section about" id="about" aria-label="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            Move forward with purpose and strength. Remain composed when faced with challenges,
             allowing your focus to stay steady. Adaptability and flexibility in the moment will lead to a better outcome. 
            Maintain balance in your approach, ensuring that actions are aligned with your goals.
            </p>

            <p class="section-text">
            It is important to maintain equilibrium in difficult times. When things seem overwhelming, 
            finding calm will help in decision-making. 
            Let growth be consistent, and always strive for improvement. Focused efforts will lead to great results.
            </p>
