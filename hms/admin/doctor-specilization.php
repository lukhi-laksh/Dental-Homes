...
<head>
    ...
    function valid() {
        let valid = true;
        let specialization = document.forms["dcotorspcl"]["doctorspecilization"].value;
        document.querySelectorAll('.error').forEach(function(el) {
            el.innerHTML = '';
        });
        if (specialization.trim() === "") {
            document.getElementById('specialization_error').innerHTML = "Doctor Specialization is required!";
            valid = false;
        }
        return valid;
    }
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="panel panel-white">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form role="form" name="dcotorspcl" method="post" onsubmit="return valid();">
