      ...
      <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="section-subtitle">Welcome To overSight</p>
          ...
          <ul class="has-scrollbar">
            ...
            <li class="scrollbar-item">
              <div class="doctor-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">Aarav Dave</a>
                </h3>
            ...
            <li class="scrollbar-item">
              <div class="doctor-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">Esha Thakor</a>
                </h3>
            ...
            <li class="scrollbar-item">
              <div class="doctor-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">Mihir Desai</a>
                </h3>
            ...
            <li class="scrollbar-item">
              <div class="doctor-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">Niyati Mehta</a>
                </h3>
