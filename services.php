            ...
            <li>
              <div class="service-card">
                ...
                <div>
                  ...
                  <p class="card-text">
                  The elegant line is at the threshold, with the layout of the elements.
                  </p>
                </div>
            ...
            <li>
              <div class="service-card">
                ...
                <div>
                  ...
                  <p class="card-text">
                  The structure is upright, with the elements of the layout not constrained by the framework.
                  </p>
                </div>
            ...
            <li>
              <div class="service-card">
                ...
                <div>
                  ...
                  <p class="card-text">
                  The structure is gracefully upright, with the layout of elements fitting the form.
                  </p>
                </div>
            ...
            <li>
              <div class="service-card">
                ...
                <div>
                  ...
                  <p class="card-text">
                  The structure is upright, and the layout of the elements is not constrained by the framework.
            ...
            <li>
              <div class="service-card">
                ...
                <div>
                  ...
                  <p class="card-text">
                  The structure is upright, and the layout of the elements complements the framework.
                  </p>
                </div>
            ...
            <li>
              <div class="service-card">
                ...
                <div>
                  ...
                  <p class="card-text">
                  The structure is upright, with the layout of elements complementing the framework.
